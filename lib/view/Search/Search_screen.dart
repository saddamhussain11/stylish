...
class SearchScreen extends StatefulWidget {
  ...
  @override
  State<SearchScreen> createState() => _FavoriteScreenState();
}

class _FavoriteScreenState extends State<SearchScreen> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          Padding(
            padding: EdgeInsets.symmetric(horizontal: 25.w),
            child: InkWell(onTap: () {}, child: Icon(Appicons.search)),
          ),
        ],
      ),
      body: Column(
