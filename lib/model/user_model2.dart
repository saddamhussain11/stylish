...
class Usermodel2 {
  ...
  Usermodel2({this.page, this.perPage, this.total, this.totalPages, this.data, this.support});
  ...
  static List<Usermodel2> fromList(List<Map<String, dynamic>> list) {
    return list.map(Usermodel2.fromJson).toList();
  }
